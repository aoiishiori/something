...
public class JsonWriter {
    ...
    public static void writeUserCart(String username, ArrayNode cartItems) {
        synchronized (new Object()) {
            try {
                String baseUser = getBaseUsername(username);

                File dir = new File(DATA_DIR + "carts/");
                dir.mkdirs();

                ObjectNode root = mapper.createObjectNode();
                root.set("cart", cartItems);
                ...
                System.err.println("[JsonWriter] writeUserCart failed: " + e.getMessage());
            }
        }
    }
