...
public class AuthModel {
    ...
    public LoginResult login(String username, String password) {
        ...
        String request  = RMIClient.buildRequest("LOGIN", username, data);
    ...
    public RegisterResult register(String username, String password, String role) {
        ...
        String request = RMIClient.buildRequest("REGISTER", username, data);
        String response = RMIClient.sendRequest(request);
    ...
    public ChangePasswordResult changePassword(String username, String oldPassword, String newPassword) {
        ...
        String request = RMIClient.buildRequest("CHANGE_PASSWORD", username, data);
        String response = RMIClient.sendRequest(request);
